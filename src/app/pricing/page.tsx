         ...
         <MaxWidthWrapper className='mb-8 mt-24 text-center max-w-5xl'>
            <div className='mx-auto mb-10 sm:max-w-lg'>
               ...
               <p className='mt-5 text-gray-600 sm:text-lg'>
                  Whether you&apos;re just trying out our service or need more, we&apos;ve got covered.
               </p>
            </div>
                        ...
                        return (
                           <div key={plan}
                              ...
                              <div className='p-5'>
                                 ...
                                 <div className='p-5'>
                                    {plan === "Free" ? (
                                       <Link href={authUser ? "/dashboard" : "/sign-in"} className={buttonVariants({
                                          className: "w-full",
                                          variant: "secondary",
                                       })}>
                                          {authUser ? "Upgrade Now" : "Sign up"}
